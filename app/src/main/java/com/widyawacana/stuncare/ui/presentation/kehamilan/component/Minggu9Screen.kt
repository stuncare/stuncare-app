...
@Composable
fun Minggu9Screen(navController: NavController) {
    Column(
        modifier = Modifier
        ...
        Card(
            ...
            Column(modifier = Modifier) {
                Image(
                    painter = painterResource(id = R.drawable.minggu_9),
                ...
                Spacer(modifier = Modifier.height(20.dp))
                Text(
                    text = "Bayi Bunda Seukuran Buah Kurma",
                    fontSize = 16.sp, fontWeight = FontWeight.SemiBold,
                    modifier = Modifier.padding(horizontal = 16.dp)
                )
                Spacer(modifier = Modifier.height(16.dp))
                Text(
                    text = "Memasuki usia sembilan minggu kehamilan, menjadi tahapan kritis pembentukan organ tubuh bayi. Organ reproduksi bayi mulai terbentuk, bersamaan dengan beberapa organ kunci lainnya, seperti pankreas dan kantung empedu. Pada minggu ini, ukuran bayi dua kali lipat.\n" +
                            "\n" +

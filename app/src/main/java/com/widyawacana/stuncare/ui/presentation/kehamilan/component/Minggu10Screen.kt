...
@Composable
fun Minggu10Screen(navController: NavController) {
    Column(
        modifier = Modifier
        ...
        Card(
            ...
            Column(modifier = Modifier) {
                Image(
                    painter = painterResource(id = R.drawable.minggu_10),
                ...
                Spacer(modifier = Modifier.height(20.dp))
                Text(
                    text = "Bayi Bunda Seukuran Buah Tin",
                    fontSize = 16.sp, fontWeight = FontWeight.SemiBold,
                    modifier = Modifier.padding(horizontal = 16.dp)
                )
                Spacer(modifier = Modifier.height(16.dp))
                Text(
                    text = "Di minggu ini, banyak perubahan terjadi pada perkembangan janin. Pada usia sepuluh minggu, jari-jari tangan dan kaki yang sebelumnya masih menempel, kini sudah terpisah dan tumbuh.\n" +
                            "\n" +
